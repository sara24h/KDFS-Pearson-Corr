...
parser.add_argument('--pruned_model_path', type=str, default='/kaggle/input/200k-pearson-pruned/pytorch/default/1/200k_kdfs_pruned.pt', help='Path to the pruned model checkpoint')
