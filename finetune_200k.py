...
def get_transforms(dataset_name, is_train=True):
    ...
    if dataset_name == "wild":
        ...
        raise ValueError(f"Dataset '{dataset_name}' is not supported. Valid options: 'wild', 'rvf10k'")
...
def main(args):
    ...
    if args.dataset == "wild":
        ...
        raise ValueError("Dataset must be 'wild' or 'rvf10k'.")
        ...
        if global_rank == 0:
            ...
            checkpoint_inference = {
                ...
                'training_config': {
                    ...
                    'input_size': [256, 256],
                    'normalization_mean': RVF10K_MEAN if args.dataset == 'rvf10k' else WILD_MEAN,
                    'normalization_std': RVF10K_STD if args.dataset == 'rvf10k' else WILD_STD,
                }
            }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, required=True,
                        help="Base path to the dataset directory (e.g., /path/to/rvf10k_dataset)")
    parser.add_argument('--model_path', type=str, required=True,
                        help="Path to the pretrained pruned model checkpoint (.pt file)")
