...
from torch.utils.checkpoint import checkpoint_sequential  # اضافه شده برای gradient checkpointing
...
class ResNet_pruned(nn.Module):
    ...
    def forward(self, x):
        ...
        # اعمال gradient checkpointing روی layer3 و layer4
        out = checkpoint_sequential(self.layer3, segments=2, input=out)
        feature_list.append(out)

        out = checkpoint_sequential(self.layer4, segments=2, input=out)
        feature_list.append(out)
