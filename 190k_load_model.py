...
checkpoint_path = '/kaggle/input/190k-pearson-seed2025-data/results/run_resnet50_imagenet_prune1/student_model/finetune_ResNet_50_sparse_best.pt'
...
try:
    save_path = '/kaggle/working/190k_resnet50_pruned_model_learnable_masks.pt'
    ...
    save_path_weights = '/kaggle/working/190k_resnet50_pruned_weights_learnable_masks.pt'
