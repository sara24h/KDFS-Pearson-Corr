...
parser.add_argument('--pruned_model_path', type=str, default='/kaggle/input/190k-pearson-seed2025/pytorch/default/1/190k_final.pt', help='Path to the pruned model checkpoint')
parser.add_argument('--output_path', type=str, default='/kaggle/working/190k_pearson_finetuned_on_20k_wild.pth', help='Path to save the fine-tuned model')
...
parser.add_argument('--freeze_strategy', type=str, default='up_to_l3', choices=['none', 'fc_only', 'up_to_l3', 'up_to_l4'],
